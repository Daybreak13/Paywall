...
namespace Paywall
{
    ...
    /// </summary>
    public class PlayableCharacter : CharacterIRE, IPlayableCharacter, MMEventListener<PaywallEXChargeEvent>, MMEventListener<RunnerItemPickEvent>, MMEventListener<PaywallKillEvent>, MMEventListener<MMGameEvent>
    {
        ...
        public GameObject CharGameObject => this.gameObject;

        public class Factory : PlaceholderFactory<IPlayableCharacter> { }
