...
namespace Paywall.Tools {
    ...
    [CustomPropertyDrawer(typeof(FieldEnumConditionAttribute))]
    public class FieldEnumConditionAttributeDrawer : PropertyDrawer {
#if UNITY_EDITOR
		public override void OnGUI(Rect position, SerializedProperty property, GUIContent label) {
			FieldEnumConditionAttribute enumConditionAttribute = (FieldEnumConditionAttribute)attribute;
		...
		private bool GetConditionAttributeResult(FieldEnumConditionAttribute enumConditionAttribute, SerializedProperty property) {
			bool enabled = true;
			...
			enumProp = property.serializedObject.FindProperty(string.Format("<{0}>k__BackingField", enumPropPath));
